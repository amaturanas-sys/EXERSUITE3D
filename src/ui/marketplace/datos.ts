...
export const CATALOGO: Producto[] = [
  ...
  { id: "sc-barra", marcaId: "steelcore", nombre: ["Barra olímpica Steel Core 20 kg", "Steel Core 20 kg olympic bar"], categoria: "pesos", precio: 245, nota: ["Cromada, Ø 28 mm, moleteado medio", "Chromed, Ø 28 mm, medium knurl"], rating: "★★★☆☆ 3.8", arte: ARTE.barra, lanzadoHaceDias: 210 },
  ...
  { id: "ex-jota", marcaId: "equipx", nombre: ["Par de jotas con rodillo UHMW", "UHMW roller J-hook pair"], categoria: "accesorios", precio: 95, antes: 115, nota: ["Calza en pinholes de 5 cm", "Fits 5 cm pinholes"], rating: "★★★☆☆ 3.8", arte: ARTE.jota, lanzadoHaceDias: 380 },
