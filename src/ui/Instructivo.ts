...
const FAQ: { id: string; pregunta: string; puntos: string[] }[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      "VENTANA IZQUIERDA APILADA: cinco barras colapsables en una sola columna con su propia barra de deslizamiento — TOOLBOX (las seis herramientas), PIEZAS DISPONIBLES, PROPIEDADES, CONEXIONES y ARRASTRE PRECISO. Toca el título de cada barra para plegarla o desplegarla; todo el flujo de trabajo vive en la misma ventana.",
      "TOOLBOX / barra de herramientas rápidas (también en el borde derecho): seis atajos con icono — selección única, selección de área, mover, rotar, escalar y orbitar. Con selección u orbitar el gizmo queda inactivo (nada se arrastra por accidente); con orbitar el toque solo mueve la cámara.",
