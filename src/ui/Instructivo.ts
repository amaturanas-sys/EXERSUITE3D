...
const FAQ: { id: string; pregunta: string; puntos: string[] }[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      "🧍 COLOCAR MANIQUÍ (en la ventana del maniquí y en la barra de simulación): al soltarlo, la figura APOYA de verdad — glúteos sobre el asiento y espalda contra el respaldo, sin quedar flotando. Apunta y el puntero va marcando dónde caería — verde sobre un APOYO ergonómico (asiento, respaldo, banco), azul sobre el SUELO. El clic lo deja puesto con su orientación: sentado sobre la cara del asiento mirando a su frente, o de pie mirando a la máquina más cercana. Vale en construcción y en simulación, en el Builder y en el Viewer.",
      "🦴 VENTANA DEL MANIQUÍ: una sola ventana con dos modos. En POSAR está todo lo que fija la postura de partida — postura guardada, agarrar, colocar, simetría, apoyo de manos y un SELECTOR DE ARTICULACIÓN con las mismas ocho familias y su lado, para elegir cuál posar sin cazar el miembro en el visor. En SIMULAR está el candado por familia articular (columna, cuello, hombro, codo, muñeca, cadera, rodilla, tobillo) con selector de lado (izquierda, derecha o simétrico). La figura NACE CON TODO BLOQUEADO: marca solo lo que quieras mover. El candado solo afecta al movimiento 8/9; posar y apoyar manos y pies siguen disponibles siempre.",
      "LAS TECLAS 8 y 9 flexionan y extienden A LA VEZ todo lo liberado (8 flexiona, 9 extiende), y los mismos botones están en la ventana y en la barra de simulación. Se usan números y no los cursores ▲▼ porque esas teclas las reclama el navegador para recorrer los botones de la interfaz. La articulación NO se frena contra el hierro: recorre su rango entero y, si el cuerpo choca, se avisa — ese choque es la evidencia de que la máquina no deja sitio, no un fallo que haya que esconder.",
  ...
  },
  {
    ...
    puntos: [
      ...
      "DEMOSTRACIÓN DE MOVIMIENTO del maniquí: en el modo SIMULAR de la ventana 🦴 libera las articulaciones que quieras mover y las teclas 8 y 9 las flexionan y extienden A LA VEZ dentro del rango humano — 8 FLEXIONA siempre, sea codo, rodilla, cadera u hombro. Las bloqueadas no se mueven y el resto del cuerpo sigue la cadena.",
