...
const FAQ: { id: string; pregunta: string; puntos: string[] }[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      "LA ESTRUCTURA FRENA A ▲▼: con la simulación en marcha, una articulación deja de girar en cuanto su segmento fuera a meterse en el hierro — el brazo se para contra el pilar en vez de atravesarlo. Un segmento que ya estaba rozando sí puede seguir moviéndose, incluso para salir. Fuera de la simulación no hay tope: posar es libre.",
      ...
      "Ojo: una figura sentada muy cerca de un brazo móvil LE QUITA RECORRIDO, igual que una persona de verdad. Si una estación se queda corta, aparta o repostura el maniquí.",
  ...
  },
  {
    ...
    puntos: [
      ...
      "DEMOSTRACIÓN DE MOVIMIENTO del maniquí: libera en 🦴 Articulaciones las que quieras mover y los cursores ▲/▼ (o las flechas del teclado) las flexionan y extienden A LA VEZ dentro del rango humano — ▲ FLEXIONA siempre, sea codo, rodilla, cadera u hombro. Las bloqueadas no se mueven, el resto del cuerpo sigue la cadena, y la ESTRUCTURA hace de tope: ninguna articulación mete su segmento dentro del hierro.",
