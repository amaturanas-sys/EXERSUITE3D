...
const FAQ: { id: string; pregunta: string; puntos: string[] }[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      "🦴 VENTANA DEL MANIQUÍ: una sola ventana con dos modos. En POSAR está todo lo que fija la postura de partida — postura guardada, agarrar, colocar, simetría y apoyo de manos. En SIMULAR está el candado por familia articular (columna, cuello, hombro, codo, muñeca, cadera, rodilla, tobillo) con selector de lado (izquierda, derecha o simétrico). La figura NACE CON TODO BLOQUEADO: marca solo lo que quieras mover. El candado solo afecta al movimiento 8/9; posar y apoyar manos y pies siguen disponibles siempre.",
