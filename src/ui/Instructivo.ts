...
const FAQ: { id: string; pregunta: string; puntos: string[] }[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      "TOOLBOX (barra vertical del borde derecho): seis atajos con icono — selección única, selección de área, mover, rotar, escalar y orbitar. Con selección u orbitar el gizmo queda inactivo (nada se arrastra por accidente); con orbitar el toque solo mueve la cámara.",
