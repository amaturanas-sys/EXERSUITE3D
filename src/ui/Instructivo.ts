...
const FAQ: { id: string; pregunta: string; puntos: string[] }[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      "↺ POSTURA DE PARTIDA: se fija sola al aplicar una postura, al colocar la figura y al pulsar ▶, y puedes clavarla a mano con 📌 Fijar partida. Parar la simulación devuelve la figura a ella y el ↺ la devuelve sin parar, así que el mismo gesto se repite tantas veces como quieras desde el mismo punto.",
