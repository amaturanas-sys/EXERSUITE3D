...
const FAQ: { id: string; pregunta: string; puntos: string[] }[] = [
  ...
  },
  {
    ...
    puntos: [
      "En el canvas Completo la techumbre es una capa oscura copia fiel del suelo con sus alturas A/B y pendiente; las paredes N/S/E/O siguen el contorno y sirven de anclaje.",
