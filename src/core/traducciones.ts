...
export const TRADUCCIONES: Record<string, string> = {
  ...
  "Proyectos: crea, abre o continúa. Cada proyecto se abre con BUILDER para construirlo, con VIEWER para mirarlo pieza a pieza o con SIMULAR para correr su física.":
    "Projects: create, open or resume. Every project opens with BUILDER to build it, with VIEWER to look at it piece by piece, or with SIMULAR to run its physics.",
